class pythonel::interpreter::rh_python36_scl {

    $interpreter = 'rh_python36_scl'
    $bindir      = '/opt/rh/rh-python36/root/usr/bin'
    $packages    = ['rh-python36', 'rh-python36-python-devel', 'rh-python36-python-pip', 'rh-python36-python-virtualenv']
